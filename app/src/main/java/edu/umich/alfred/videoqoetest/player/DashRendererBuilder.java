 ...
 */
package edu.umich.alfred.videoqoetest.player;
...
import edu.umich.alfred.videoqoetest.EventLogger;
import edu.umich.alfred.videoqoetest.player.DemoPlayer.RendererBuilder;
  ...
  private static final class AsyncRendererBuilder
    ...
    private void buildRenderers() {
      ...
      try {
        ...
        Log.d(TAG, "Alfred: exception MediaCodecUtil.DecoderQueryException");
        e.printStackTrace();
      }
      for (int i = 0; i < period.adaptationSets.size(); i++) {
        AdaptationSet adaptationSet = period.adaptationSets.get(i);
